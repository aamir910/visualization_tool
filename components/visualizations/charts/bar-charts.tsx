...
export function VerticalBarChart() {
  ...
  useEffect(() => {
    ...
    const maxY = d3.max(sampleData, (d) => d.value);
...
export function HorizontalBarChart() {
  ...
  useEffect(() => {
    ...
    const maxX = d3.max(sampleData, (d) => d.value);
...
export function StackedBarChart() {
  ...
  useEffect(() => {
    ...
    const maxY = d3.max(data, (d) => d.group1 + d.group2 + d.group3);
    if (maxY === undefined) return;
    ...
    const stackedData = d3.stack().keys(["group1", "group2", "group3"])(data as any);
